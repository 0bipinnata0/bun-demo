...
import { Scope, createContextScope } from "@kane/create-context";
import { ThemeableStack } from "@kane/stacks";
import { useControllableState } from "@kane/use-controllable-state";
...
const [GroupProvider, useGroupContext] =
	createGroupContext<GroupContextValue>(GROUP_NAME);
...
export const useGroupItem = (
	...
	const isFirst =
		forcePlacement === "first" ||
		(forcePlacement !== "last" && treeIndex.index === 0);
	const isLast =
		forcePlacement === "last" ||
