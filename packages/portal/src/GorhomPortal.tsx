...
const PortalStateContext = createContext<Record<
	string,
	Array<PortalType>
> | null>(null);
const PortalDispatchContext = createContext<React.Dispatch<ActionTypes> | null>(
	null,
);
...
const defaultRenderer: PortalHostProps["render"] = (children) => (
	<>{children}</>
);
