...
// config is re-run by the @kane/static, dont double validate
					...
					for (const key in fontDeclarations) {
						...
						const selectors =
							language === "default"
								...
								: langSelector;
						const specificRuleSet = declarationsToRuleSet(
							declarations,
							selectors,
						);
