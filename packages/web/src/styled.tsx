...
>(
		...
		: AreVariantsUndefined<ParentVariants> extends true
		  ...
		  : {
					[Key in keyof ParentVariants | keyof OurVariantProps]?:
						| (Key extends keyof ParentVariants
								? ParentVariants[Key]
								: undefined)
						| (Key extends keyof OurVariantProps
								? OurVariantProps[Key]
								: undefined);
			  };
	...
	const parentStaticConfig = ComponentIn.staticConfig as
		| StaticConfig
		| undefined;
	...
	const isNonStyledHOC =
		parentStaticConfig?.isHOC && !parentStaticConfig?.isStyledHOC;
